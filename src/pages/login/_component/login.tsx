...
import { authenActions, loginAction } from '@/stores/authentication';
                    ...
                    >
                      <Form className=" flex w-full flex-col bg-white p-4">
                        ...
                        <button
                          ...
                          className=" flex w-full items-center justify-end pt-2"
                        >
                          <span className="text-xl font-bold text-green-400 underline hover:!text-blue-700">
                            Quên mật khẩu?
                          </span>
                        </button>
                        <motion.div
                        ...
                        >
                          ...
                          <div className="flex flex-row items-center justify-center pt-4 text-center">
                            <span className="text-xl font-bold text-black ">
                              ...
                              <button type="button" onClick={handlePressRegister}>
