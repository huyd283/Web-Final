...
import slide1 from '@/public/assets/images/home/bg0.jpg';
import slide2 from '@/public/assets/images/home/bg2.jpg';
import slide3 from '@/public/assets/images/home/bg3.jpg';
          ...
          >
            {_.map(data, (item) => (
              <SwiperSlide key={item.id}>
                <div>
                  <div className="max-h-[28.75rem] items-center">
                    {/* <div */}
                    {/*  className="w-20 h-20" */}
                    ...
                    <Link href="/">
                      <Image
                        src={item.image}
                        className="max-h-[28.75rem] w-full object-contain"
                        alt="icon-x"
                      />
                    </Link>
                    {/* </div> */}
